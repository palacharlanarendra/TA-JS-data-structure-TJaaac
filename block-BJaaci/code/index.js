...
let keyActors = movies[0].actors;
for(let i=0;i<keyActors.length;i++){
  console.log(`${i} : ${keyActors[i]}`);
}
...
let allThirdGenres = movies[2].genres;
console.log(allThirdGenres);
// 13. Log all the genres of the first movie
let allFirstGenres = movies[0].genres;
console.log(allFirstGenres);
...
for(let i=0;i<allFirstGenres.length;i++){
  console.log(`First movie genres : ${allFirstGenres[i]}`);
}
// 19. Log all the genres of the second movie one by one
let allSecondGenres = movies[1].genres;
for(let i=0;i<allSecondGenres.length;i++){
  console.log(`Second movie genres : ${allSecondGenres[i]}`);
}
...
console.log(`Log the name of all the movies with exactly 3 actors`)
for(let i=0;i<movies.length;i++){
